...
class CTComicListController: CTBaseController {
  ...
  private lazy var tableView: UITableView = {
        ...
        tableView.register(cellType: CTComicTVCell.self)
...
extension CTComicListController: UITableViewDelegate, UITableViewDataSource {
