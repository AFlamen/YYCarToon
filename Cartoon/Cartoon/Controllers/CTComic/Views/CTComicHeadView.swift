...
class CTComicHeadCollectionCell: CTBaseCollectionViewCell {
...
class CTComicHeadView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(cellType: CTComicHeadCollectionCell.self)
    ...
    var detailStatic: CTComicStaticModel? {
        didSet {
    ...
    var detailRealtime: CTComicRealtimeModel? {
        didSet {
...
extension CTComicHeadView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return themes?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: CTComicHeadCollectionCell.self)
